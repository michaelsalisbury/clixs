...
<form id="pwauth" action="#" method="post">
	<fieldset class="personalblock">
		...
		<label for="test_code"><?php echo $l->t('test_code');?></label><input type="text" id="test_code" name="test_code" value="<?php echo $_['test_code']; ?>"  original-title="<?php echo $l->t('test_code'); ?>"/>
		</p>

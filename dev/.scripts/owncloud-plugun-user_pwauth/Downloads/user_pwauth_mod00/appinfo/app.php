...
//define('OC_USER_BACKEND_PWAUTH_UID_LIST', '20000-90000000');
//define('OC_USER_BACKEND_PWAUTH_UID_LIST', '1968340-1968341');
define('OC_USER_BACKEND_PWAUTH_PATH', '/usr/sbin/pwauth');
define('OC_USER_BACKEND_TEST_CODE', 'hello world');

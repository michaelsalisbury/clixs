...
define('OC_USER_BACKEND_PWAUTH_USR_LIST', '@users');
define('OC_USER_BACKEND_PWAUTH_ADM_LIST', '@wheel');
define('OC_USER_BACKEND_PWAUTH_LIST_DELIM', ';');
define('OC_USER_BACKEND_PWAUTH_GROUP_PREFIX', '@');
define('OC_USER_BACKEND_PWAUTH_MIN_ID', '100');
